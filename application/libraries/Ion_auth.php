...

{
	...
	public function forgotten_password($identity,$lang = "ar")    //changed $email to $identity
...

		{
...

			{
...

				{
					...
					$message = $this->load->view($lang."/".$this->config->item('email_templates', 'ion_auth').$this->config->item('email_forgot_password', 'ion_auth'), $data, true);
